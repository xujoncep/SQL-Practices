...
(82, 'Trail\ Head Gourmet Provisioners', 'Helvetius Nagy', '722 DaVinci Blvd.', 'Kirkland', '98034', 'USA'),
...
ALTER TABLE orders
  ...
  CREATE INDEX ShipperID ON orders (ShipperID);
...
--
--ALTER TABLE categories
--  MODIFY COLUMN CategoryID int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
